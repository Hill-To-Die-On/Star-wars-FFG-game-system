...
- Add private sourcebook OCR preparation, forced replacement of unreliable embedded text, public comparison metadata, and full printed-chart verification for the three Cyphers & Masks specializations and two Spy signature abilities.
