...
- [x] Publish copyright-bounded advancement graphs and verification metadata in the release archive, merge them into public compendium imports, and validate the complete 173-item catalogue. The current 114-test suite, release checks and 169-file build pass; printed comparisons remain tracked separately. <!-- rm:publish-advancement-graphs -->
