...
- [ ] Complete live acceptance for the public integration API version 2, including character-builder handoff, adversary/vehicle/Group import, community rules, origin isolation, review, replacement and multi-client behavior. <!-- rm:complete-api-v2-live-acceptance -->
- [ ] Complete range-overlay acceptance for multi-origin mode, map scale, persisted Theatre-of-the-Mind calibration, all three range scales, elevation and line-of-sight behavior. <!-- rm:complete-range-overlay-acceptance -->
- [ ] Complete Dice So Nice physical-hardware and multi-client visual acceptance for all seven dice, including the revised Ability and Difficulty face alignment. <!-- rm:complete-dsn-live-acceptance -->
...
- [x] Publish copyright-bounded advancement graphs and verification metadata in the release archive, merge them into public compendium imports, and validate the complete 173-item catalogue. The 110-test suite, release checks and 168-file build pass; printed comparisons remain tracked separately. <!-- rm:publish-advancement-graphs -->
