...
- [ ] Complete vehicle statistics with book/page evidence. The current structured match fills 162 of 399 vehicles; 237 records remain incomplete and must not receive guessed values. Cyphers & Masks vehicle references on pages 53 and 61 and vehicle attachments on pages 62-63 are inside the newly recorded private-scan request. <!-- rm:complete-vehicle-statistics -->
...
- [x] Publish copyright-bounded advancement graphs and verification metadata in the release archive, merge them into public compendium imports, and validate the complete 173-item catalogue. The current 117-test suite, release checks and 169-file build pass; printed comparisons remain tracked separately. <!-- rm:publish-advancement-graphs -->
