...
- [ ] Complete isolated Foundry acceptance with Director of Realms 0.10.1162 or later: run the Edge, Age and Force beginner adventures plus a mixed-ruleline campaign with two player clients and two GM-controlled party members. Verify conversational decision making before rolls, all narrative result axes, cinematic advantage/threat use, exact actor/skill/ship identity, visible scenes, map or Theatre-of-the-Mind transitions, personal combat, navigation, evasion and ship combat. A separate 0.10.1162 world now proves exact runtime discovery, compendium enrichment and a native Nara Vex Negotiation result of 2 success / 4 Advantage; the full narration request failed closed under p95 200 ms Foundry pressure, so all four campaign scenarios remain open. <!-- rm:complete-dor-live-acceptance -->
- [ ] Finish printed-chart verification for advancement. The public catalogue contains 135 specialization graphs and 36 of 38 signature graphs; 143 charts now have full node/cost/connector comparisons and 30 remain pending. Request the 24 missing specialization charts and six missing signature charts listed in `docs/source-coverage.md`; two of those signatures also lack structured graphs. <!-- rm:finish-advancement-source-verification -->
- [ ] Codify remaining rules only from structured or reviewed sources: active and situational talents, weapon qualities, Force-power upgrades, critical consequences, vehicle maneuvers, crafting, mass combat and squadron rules. Unsupported mechanics must continue to request a GM ruling. The supplied Cyphers & Masks material has now been mapped to printed pages 7-9, 12-35 and 70-95; pages 10-11 and 36-69 are explicitly requested before their mechanics are treated as reviewed. <!-- rm:codify-remaining-rules -->
- [ ] Complete vehicle statistics with book/page evidence. The public overlay now fills 312 of 399 vehicles from 221 exact structured matches, 55 reviewed aliases and 36 held printed-page checks. The remaining 87 records must not receive guessed values and are listed by exact book/page in `docs/vehicle-source-coverage.md`: 84 need complete profiles from unavailable sourcebooks, two structured conflicts need printed adjudication, and the held Foot Speeder page supplies only a partial profile. <!-- rm:complete-vehicle-statistics -->
...
- [ ] Review and merge or replace the open Dependabot npm and GitHub Actions updates after the full local matrix passes. PR #16 now contains immutable v7 replacements for GitHub Actions PRs #8–#10 and the full local matrix passes; leave the bot PRs open until that replacement reaches `dev`, because hosted checks are still blocked by the organization billing lock. No npm update is currently pending. <!-- rm:close-dependabot-updates -->
...
- [x] Serialize all XP-spending actions through one active GM or owner per actor. Unit coverage verifies deterministic authority, per-actor queueing, permission rejection and overspend prevention; live Foundry 14.368 acceptance with one GM and two simultaneous player clients accepted exactly one purchase against the same 10 XP and preserved one ledger entry. <!-- rm:serialize-xp-purchases -->
