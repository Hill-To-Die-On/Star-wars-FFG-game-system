...
| Optional Foundry interface theme             | Passed for Frontier, Rebellion and Mystic across the public-domain Cassini Saturn panorama, six custom navigation icons, pause mark, chat, populated combat tracker, windows, journals/handouts, scene controls, players and hotbar; automatic selection, manual overrides, Foundry-default opt-out, local asset loading and zero page errors verified |
